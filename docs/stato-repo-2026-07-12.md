...
| `docs/D2_OPENAI_MIGRATION_CONTRACT.md`   | 2026-06-17 | Contratto migrazione 6 fn AI → OpenAI                       | Fuorviante nello stato: «non è ancora scritta» (r.10) ma è fatta e validata (HANDOFF §2)                                                                                                                                                              |
| `docs/D3_TEST_200_RUNBOOK.md`            | 2026-06-17 | Runbook test-200 fn AI                                      | Aggiornato (WARN «deferiti D5» superati)                                                                                                                                                                                                              |
| `docs/D7_GOOGLE_OAUTH_SETUP.md`          | 2026-06-17 | Setup Google OAuth                                          | Stantio come piano: già eseguito                                                                                                                                                                                                                      |
| `docs/D8_AUDIT_CODICE_MORTO.md`          | 2026-06-17 | Audit codice morto v2                                       | Parzialmente superato da D13 (vari hook «KEEP-WIP» ora cablati)                                                                                                                                                                                       |
| `docs/D9_E2E_PLAYWRIGHT_NATIVE.md`       | 2026-06-17 | Config Playwright nativa                                    | Stantio come piano: già eseguito                                                                                                                                                                                                                      |
| `docs/D10_COACH_ROUTE_GUARD.md`          | 2026-06-17 | Guard route coach                                           | Stantio come piano: già eseguito (15 route)                                                                                                                                                                                                           |
| `docs/D11_GENERATE_PROGRAM_PLAN.md`      | 2026-06-17 | Cablaggio generate-program in UI                            | Stantio come piano: già eseguito (`8735e0d`)                                                                                                                                                                                                          |
| `docs/D12_DEADCODE_ACWR_CLEANUP_PLAN.md` | 2026-06-17 | Cleanup ACWR duplicato                                      | Parzialmente storico (Set A eseguito `6dcd2fc`)                                                                                                                                                                                                       |
| `docs/D13_AUDIT_REPORT.md`               | 2026-06-18 | Report finale campagna D13                                  | Aggiornato al 18/06                                                                                                                                                                                                                                   |
| `docs/D13_AUTONOMOUS_CAMPAIGN.md`        | 2026-06-18 | Piano campagna autonoma                                     | **Fuorviante nei rail**: R8 hand-patch types.ts (dichiarato OBSOLETO da 00-CORE §9) e R9 «security = defer Lovable» (superato da ownership condivisa)                                                                                                 |
...
| `chat-with-coach` (283r)         | Chat AI streaming con quota giornaliera. Legge profiles, ai_usage_tracking, RPC `match_documents`; **scrive ai_usage_tracking** (:139/:152/:263). OpenAI embeddings + chat (stream).                    |
...
Payload a OpenAI = system prompt (con contesto RAG), `...history` mappata a `{role, content}`, e la `query` utente (`chat-with-coach/index.ts:216-238`). Nessun nome/id atleta nel payload; il `coach_id` serve solo al retrieval `match_documents` lato Supabase (`index.ts:175`).
