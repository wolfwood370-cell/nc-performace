...
| Math readiness / TDEE / biometria          | `src/lib/math/readinessMath.ts`, `adaptiveTDEE.ts`, `biometrics.ts`, `nutritionMath.ts`, `src/types/progression.ts` | lib pure → consumate dagli hook qui sopra                      |
