...
**Migliorie azionabili.** (1) `claude/zonemap-riconc` da eliminare **senza merge** (locale + origin) — segnalato in `HANDOFF §0`, decisione Nick. (2) Deploy `generate-program` 17→18 fermato PRIMA dell'esecuzione su ordine di Nick: ri-verifica dei conteggi sua, poi merge/deploy — nota operativa nel prompt-file `docs/prompts/2026-07-12-zonemap-v18.md`.
