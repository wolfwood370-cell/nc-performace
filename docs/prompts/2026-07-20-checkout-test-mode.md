...
| #   | Decisione                                                                                   | Perché                                                                                                                                                                                                                        |
| --- | ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D1  | `hasActiveAccess` = `coaching_mode='coached'` OPPURE `subscription_status ∈ {active,trial}` | Gli atleti coached li fattura il coach fuori piattaforma: senza il ramo coached li chiuderemmo fuori dalle loro funzioni.                                                                                                     |
